...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { calificacion: @comentario.calificacion, comentario: @comentario.comentario, libro_id: @comentario.libro_id, user_id: @comentario.user_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { calificacion: @comentario.calificacion, comentario: @comentario.comentario, libro_id: @comentario.libro_id, user_id: @comentario.user_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
